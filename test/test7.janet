...
(defn main
  ...
  (while (not exit-window)
    ...
    (let [size (gui-get-style :default :text-size)
          ...
          inner-padding (gui-get-style :textbox :text-line-spacing)
    ...
    (when show-message-box
      ...
      (var result 
          (gui-message-box
            ...
            250 100 ]
            "Close Window" #(gui-icon-text :icon-exit "Close Window")
    ...
    (when (text-input-box :show)
      ...
      (set (text-input-box :result)
          (gui-text-input-box
            ...
            240 140 ]
            (gui-icon-text :icon-file-save "Save file as...")
